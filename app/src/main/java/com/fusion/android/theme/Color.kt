package com.fusion.android.theme

import androidx.compose.ui.graphics.Color

/**
 *  Material palette based on the blue and green colors from the site. Extra site colors added.
 *
 *  The material palette generated at https://m2.material.io/
 */

val JBlue = Color(0xff18a7c6)
val JLightBlue = Color(0xff63d9f9)
val JDarkBlue = Color(0xff007895)
val JDeepBlue = Color(0xff0a2b58)
val JBlueShadow = Color(0xff0a2b58)

val JGreen = Color(0xff87ba68)
val JLightGreen = Color(0xffb8ed97)
val JDarkGreen = Color(0xff588a3b)

val JGreyContour = Color(0x4b57bab6)

/**
 *  Colors from base demo
 */
